...
This course uses a design lens to parse political structures. The course defines politics as the means at which people shift power, the means in which decisions are made. Politics is part of our everyday lives, distributed but ever-present at every scale: small groups to schools to neighborhoods to nations

As a graduate interdisciplinary course, the course will introduce and frame assignments in the broadest possible way to allow for discipline-specific outcomes. 

There will be three major assignments with a few scattered activities, guests and outings. Some guests and activities will relate and reinforce the assignments, others exist to bring students access to people and issues that relate to design and politics and can inform the final project. 
...
- To cultivate existing bodies of work that relate to politics
- To encourage participation and positive change
- To introduce design methods to non-designers
...
- Where is design's role in politics?
- How are groups and organizations run?
...
Using your own affiliations as content, we'll look at how various groups organize themselves, what the benefits are to those structures, and how other relationships may be of value.
*2 weeks*

#### Unit 2: How can you speak with symbols? 
Groups and movements rally behind symbols — whether a graphic symbol, a flag, a building, a color or other symbolic mark. You'll be asked to choose a symbol and create a new work that alters or applies that symbol in a manner that expresses a point of view. 
*3 weeks*

#### Unit 3: What is public space for?
Public space has value in that it brings different people together. It provides the space for political and social acts, helping to define the cultural of a place. You will make a work (or proposal) sited in public, physical or digital, that encourages a shared experience. 
*4 weeks*
...
Week 1  Feb 18 ORG CHART
Week 2  Feb 25 SYMBOL
Week 3  Mar 4
Week 4  Mar 11 
Week 5  Mar 18 IN PUBLIC
Week 6  Mar 25
Week 7  Apr 08 Andy Pressman
Week 8  Apr 15 OPEN
Week 9  Apr 22 Earth Day (Davie Lopes?)
Week 10 Apr 29
Week 11 May 06
Week 12 May 13
Week 13 Review date and format TBD based on enrolled students' other review dates.
...
Class will be a mix of the following: lecture, activity, guest, outing, reviewing student work, sharing headlines,

## Grading

#### Rubric
- Ability to speak to the ideas that the work produced
- Complexity, Inventivenes, risk and meaning of work
