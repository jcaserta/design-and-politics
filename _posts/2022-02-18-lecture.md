...
The course should be as much about hoy, play, the insertion of culture in a form that others must contend with. Rule breaking to understand why the rules are there in the first place. What are artists if not those who change the rules for those so insistent to conform to rules.
